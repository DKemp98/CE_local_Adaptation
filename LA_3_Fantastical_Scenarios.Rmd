...
layout(matrix(c(1:2), nrow = 1, byrow = TRUE))
  ...
  many_plotted_lines(AA_growth_differs[[1]],upper_y=600,axes=FALSE,to_vis=list(AA=FALSE,AB=FALSE,BB=FALSE,overall=FALSE,legend=FALSE, show_mean=TRUE))
  axis(1, at=c(0,100,200,300,400,500), labels = FALSE,tck = 0.02)
  axis(2,at=c(0,100,200,300,400,500), labels=FALSE,tck = 0.02)
  many_plotted_lines(AA_growth_differs[[3]],upper_y=600,axes=FALSE,to_vis=list(AA=FALSE,AB=FALSE,BB=FALSE,overall=FALSE,legend=FALSE, show_mean=TRUE))
  axis(1, at=c(0,100,200,300,400,500), labels = FALSE,tck = 0.02)
  axis(2,at=c(0,100,200,300,400,500), labels=FALSE,tck = 0.02)  
