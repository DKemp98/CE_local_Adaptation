...
dispersal_even<-function(matrix1, matrix2, disp_prob1=0.1, disp_prob2=0.1, year, random=FALSE, ...){
...
dispersal_pop_dependent<-function(matrix1, matrix2, parameter1, parameter2, year,random=FALSE, ...){
  last_row1<-tail(matrix1,n=1)
  last_row2<-tail(matrix2,n=1)
  
  disp_prob1<-parameter1$l_max-parameter1$l_max / (1 + parameter1$b * parameter2$wanderlust*last_row1[,"overall"])
  disp_prob2<-parameter2$l_max-parameter1$l_max / (1 + parameter2$b * parameter2$wanderlust*last_row1[,"overall"])
...
```{r}
para_patch1<-list(N0=360, b=0.001, l_max=1.4, wanderlust=1.1)
para_patch2<-list(N0=40, b=0.001, l_max=1.4,wanderlust=0.7)
...
for(i in 1:50){
  disp_result<-dispersal_pop_dependent(Patch_1_list$matrix,Patch_2_list$matrix, Patch_1_list$parameters, Patch_2_list$parameters, year=i, random=TRUE)
