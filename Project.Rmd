...
plot(Small_changes_1[,"AA"], col=alpha("red",0.0), lty=1, lwd=1, las=1, type="l", pch=16, xlab="generations", ylab="individuals (N)", ylim=c(0,450)) # 
...
plot(Small_changes_2[,"BB"], col=alpha("blue",0.0), lty=1, lwd=1, las=1, type="l", pch=16, xlab="generations", ylab="individuals (N)", ylim=c(0,450)) # 
colors<-c("red","violet","blue","black")
...
#plot((as.numeric(freq_time[rownum,6])-as.numeric(freq_time[rownum,12])),col="black",ylim=c(-150,750),lty=1, lwd=1)
